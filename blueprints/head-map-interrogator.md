...
## Spec
One-paste spec for the conversational auditor with - **__desk_active_time_ms**: 404058
...
- **watch_tripwire**: Track per-head clause-boundary attention entropy on a weekly sample; if any single head's entropy drops below 0.35 the model engineer gets flagged and it posts to the model-health dashboard. as calibration.
