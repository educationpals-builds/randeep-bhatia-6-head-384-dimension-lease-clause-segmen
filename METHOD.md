...
## Spec
The five principles with the acronym PRISM spelled out letter by letter — Partition the Space, Run in Parallel, Individuate the Pattern, Stitch the Spectra, Map What Each Head Sees — and the collapse-to-monochrome anti-pattern. The letters appear only in this file.
