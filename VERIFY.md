...
## Spec
Stranger verification: run the seeded specimen through /play, confirm the tool surfaces the unowned-relationship finding and demands a per-head number for it.
